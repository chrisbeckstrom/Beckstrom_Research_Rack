...
// in template, this file is called "MyModule.cpp"
...
void MyModule::step() {
	...
	pitch = (clampf(pitch, -6.0, 6.0))*1; // cb addition
...
MyModuleWidget::MyModuleWidget() {
...

	{
		...
		panel->setBackground(SVG::load(assetPlugin(plugin, "res/CBhfo.svg")));
		addChild(panel);
	}
	...
	addParam(createParam<Rogan1PSBlue>(Vec(28, 87), module, MyModule::PITCH_PARAM, -9.0, 9.0, 0.0));
